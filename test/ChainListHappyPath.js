...
contract('ChainList', function(accounts) {
    ...
    it("seller should be able to sell an article", function() {
        return ChainList.deployed().then(function(instance) {
            chainListInstance = instance;
            ...
            assert.equal(data.length, 1, "there must be only 1 article for sale")
    ...
    it("seller should be able to sell second article", function() {
        return ChainList.deployed().then(function(instance) {
            chainListInstance = instance;
            return chainListInstance.sellArticle(
                articleName2,
            ...
            assert.equal(data.toNumber(), 2, "number of articles must be 1")

            return chainListInstance.getArticlesForSale();
        }).then(function(data) {
            console.log(data[1].length);
            assert.equal(data.length, 2, "there must be only 2 articles for sale")
